"""Deployment configuration for Kalshi data fetching flow."""
...
if __name__ == "__main__":
    ...
    github_source.save("kalshi-github-repo", overwrite=True)
    
    deployment = flow.from_source(
            source=github_source,
            entrypoint="src/flows/fetch_kalshi_data.py:fetch_kalshi_data_flow",
        ).deploy(
            name="kalshi-5min",
